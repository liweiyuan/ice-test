...
public interface HelloPrx extends com.zeroc.Ice.ObjectPrx {
	...
	default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_sayHelloAsync(String iceP_s,
	...
	static HelloPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, String facet, java.util.Map<String, String> context) {
		return com.zeroc.Ice.ObjectPrx._checkedCast(obj, facet, context, ice_staticId(), HelloPrx.class,
				_HelloPrxI.class);
	}
	 ...
	 * 
	 * @param newCache
	 *            <code>true</code> if the new proxy should cache connections;
	 ...
	 * 
	 * @param b
	 *            If <code>b</code> is <code>true</code>, only endpoints that use a
	 ...
	 * 
	 * @param b
	 *            If <code>b</code> is <code>true</code>, the new proxy will use
	 *            secure endpoints for invocations and only use insecure endpoints
	 *            if an invocation cannot be made via secure endpoints. If
	 *            <code>b</code> is <code>false</code>, the proxy prefers insecure
	 ...
	 * 
	 * @param b
	 *            <code>true</code> if the new proxy enables collocation
	 ...
	 * 
	 * @param co
	 *            <code>true</code> enables compression for the new proxy;
	 ...
	 * 
	 * @param t
	 *            The connection timeout for the proxy in milliseconds.
